...
Navigate to Bedrock: Search for "Bedrock"
Select region: e.g., eu-central-1 (Frankfurt), us-east-1
Model Access:
Go to "Model access"
...
- Local models – for maximum data privacy  
