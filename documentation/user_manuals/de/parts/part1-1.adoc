...
|===
|
image::../images/Abbildung-34.jpg[Dokument herunterladen, title=""]  
| Dokument herunterladen   | 
|
image::../images/Abbildung-35.jpg[Embeddings laden]		
| Embeddings laden (einzeln nachladen)   | 
|
image::../images/Abbildung-36.jpg[Aus RAG-System ((Retrieval Augmented Generation)) entfernen (Dokument bleibt in der Ordnerstruktur gespeichert)] 
| Aus RAG-System ((Retrieval Augmented Generation)) entfernen (Dokument bleibt in der Ordnerstruktur gespeichert)   | 
|
image::../images/Abbildung-37.jpg[Dokument endgültig löschen] 
