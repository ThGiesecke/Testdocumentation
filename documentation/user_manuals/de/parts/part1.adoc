...
Alle Chatverläufe werden im Browser gespeichert und sind nach dem Browser schließen (Wenn Einstellung "automatischem Cache leeren") und Neuanmeldung nicht weiter verfügbar.
Alle gespeicherten Use Case Verläufe können auch nach dem Browser schließen und Neuanmeldung wieder geöffnet werden.
...
Innerhalb der gesamtem Anwendung werden beim Erstellen oder Speichern in der oberen linken Ecke farbige Hinweisdialoge mit Statusanzeige dargestellt.
