...
- „Lizenz abgelaufen“  
 ...
 - „Datenbankverbindung fehlgeschlagen“
	Kontrollieren Sie die Erreichbarkeit und den Status der Datenbank und prüfen Sie die Zugangsdaten der Verbindungszeichenfolge in der Konfigurationsdatei.
